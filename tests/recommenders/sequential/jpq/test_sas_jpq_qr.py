...
class TestSASRecJPQBPR(unittest.TestCase):
    def setUp(self):
        os.environ['CUDA_VISIBLE_DEVICES'] = '-1'

    def test_sasjpq_bpr(self):
        ...
        model_config = SASJPQConfig(embedding_size=32, vanilla_num_negatives=5, vanilla_bce_t=1, centroid_strategy='qr', pq_m=2)
